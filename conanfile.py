...
from cmake_common import (cmake_dependencies, cmake_dependency_vars,
...
def extend(cpp_info, config):
    ...
    if config_info:
        ...
        result.includedirs = add_lists(
            cpp_info.includedirs, config_info.includedirs)
...
class CMakeMultiGenerator(Generator):
    ...
    def _content_type(self, build_type):
        ...
        for dep_name, dep_cpp_info in self.deps_build_info.dependencies:
            ...
            dep_flags = cmake_dependency_vars(
                dep_name, deps=deps, build_type=build_type)
    ...
    def _content_multi(self):
        ...
        # TARGETS
        sections.extend(generate_targets_section(
            self.deps_build_info.dependencies))
...
class CMakeMultiGeneratorPackage(ConanFile):
    name = "CMakeMultiGenerator"
    version = "0.1"
    author = "Joaquín Herrero Herrero"
    url = "https://github.com/joaquin-herrero/conan-custom-cmake_multi-generator"
    license = "MIT"
    exports = "cmake_common.py", "__init__.py"
